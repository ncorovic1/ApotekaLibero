						...
						<div class="inner-header clearfix">
							...
							<nav class="main-navigation pull-right hidden-xs hidden-sm">
								<ul>
									...
									<li><a id="eng" href="../adminus/admin.php">English</a></li>
								</ul>
							</nav>
						</div>
					</div>
                                ...
                                <span><i class=""></i></span>   
                                    <form id="imageform" method="POST" enctype="multipart/form-data" action="admin.php">
                                        <div class="tittle tittle2"> 
                                            <input class="input" name="naslov" type="text" placeholder="Naslov">
                                        </div>
                                        ...
                                        <textarea name="tekst" cols="40" rows="5" placeholder="Tekst"></textarea><br>
                                        <input type="submit" class="submit" value="Nova usluga" name="novaUsluga">
                                    </form>  
                             </div>
                         </div>
					 </div>
                    ...
                    <div class="container container2">
                        ...
                        <div class="novost novost2">
                            <form method="POST" action="admin.php" id="formaNovost">
                                 <div class="tittle tittle2"> 
                                            <input class="input" name="naslovN" type="text" placeholder="Naslov">
                                 </div>
                                 <textarea name="tekstN" cols="40" rows="5" placeholder="Tekst"></textarea><br>
                                <input type="submit" class="submit" value="Nova novost" name="novaNovost">
                            </form>
                        </div>
                    </div>
                </section>
							...
							<div class="col-md-3 col-md-3n2">
								...
								<div class="links links2">
									...
									<ul>
										...
										<li><a href="../oNama.php">O nama</a></li>
										<li><a href="../kontakt.php">Kontakt</a></li>   
										<li><a href="../adminus/admin.php">English</a></li>
									</ul>
								</div>
								<div class="spacing"></div>
							</div>
